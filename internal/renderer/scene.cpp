...
{
    objects.emplace_back(std::make_shared<Mesh>(device, "assets/viking_room.obj", "assets/viking_room.png"));
    ...
    mesh2->texture = std::make_unique<Texture>(device, 2, 2, imagePixels.data(), VK_FORMAT_R8G8B8A8_SRGB,
